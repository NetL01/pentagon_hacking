...
def humanizer_initial():
    ...
    ini('Checking for an existing version')
    print('A new version has been found, we recommend downloading')
    time.sleep(0.2)
    runhum = input('running? (y/N): ')
    if runhum == 'y' or runhum == 'Y':
        time.sleep(0.2)
        cls_shell()
        print('Deploying from: gh repo clone NetL01/Neur_Humanizer')
        time.sleep(0.6)
        ...
        print('Raising old configuration archives')
        time.sleep(0.6)
        ini('Doing')
        print('Loaded: True')
        time.sleep(0.5)
        ...
        time.sleep(0.15)
        print('All files are working properly')
    ini('Initialize process')
